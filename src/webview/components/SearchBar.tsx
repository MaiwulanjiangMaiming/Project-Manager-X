...
export default function SearchBar({ value, onChange, onDebouncedChange, sortBy, onSortChange, viewMode, onViewModeChange, onRefresh, onSaveCurrentProject, onAddDetectFolder, onEditProjectsFile, onImportFromProjectManager }: SearchBarProps) {
  return (
    <div className="search-bar">
      ...
      <div className="search-actions">
        ...
        <button className="save-project-btn" onClick={onSaveCurrentProject} data-tip="Save current project">
          <svg viewBox="0 0 16 16" fill="currentColor">
        ...
        <button className="add-folder-btn" onClick={onAddDetectFolder} data-tip="Add folder to scan">
          <svg viewBox="0 0 16 16" fill="currentColor">
            <path d="M14.5 3H7.71l-.85-.85L6.29 2H1.5l-.5.5v10l.5.5h13l.5-.5v-9l-.5-.5zM14 13H2V5h12v8z"/>
            <path d="M8 6v2H6v1h2v2h1v-2h2V8H9V6H8z"/>
          </svg>
        </button>
        <button className="edit-file-btn" onClick={onEditProjectsFile} data-tip="Edit projects.json">
          <svg viewBox="0 0 16 16" fill="currentColor">
        ...
        <button className="import-btn" onClick={onImportFromProjectManager} data-tip="Import from Project Manager">
          <svg viewBox="0 0 16 16" fill="currentColor">
